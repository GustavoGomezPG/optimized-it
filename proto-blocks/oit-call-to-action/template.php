...
<section <?php echo $wrapper_attributes; ?>>
  <div class="max-w-[1440px] mx-auto px-6 lg:px-20">
    ...
    <div class="oit-call-to-action__row flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between lg:gap-10">
      ...
      <div class="oit-call-to-action__intro flex flex-col gap-5 max-w-[900px] min-w-0 lg:flex-1">
        <h2
      ...
      <a
        ...
        class="oit-call-to-action__cta self-start shrink-0 inline-flex items-center gap-3 px-5 py-2.5 rounded-full border-2 border-cta-red text-black hover:bg-cta-red hover:text-white no-underline font-grotesk font-medium text-body-sm leading-[1.3] uppercase whitespace-nowrap transition-colors lg:self-end">
